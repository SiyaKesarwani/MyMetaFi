...
import "contracts/collective/ICollectiveFactory.sol";
import "contracts/collective/Collective.sol";
import "contracts/collective/distribution/Distributor.sol";
import "contracts/collective/distribution/IDistributor.sol";
...
contract CollectionNFTCrowdfundTest is Test, TestUtils {
    ...
    string defaultCollectiveTitleName = "CollectionNFTBuyCrowdfund";
    ...
    CollectionNFTCrowdfund collectionNFTCrowdfundImpl;
    CollectionNFTCrowdfund ccf;
    DummyERC20 defaultTokenContract = new DummyERC20();
    ...
    constructor() {
        collectionNFTCrowdfundImpl = new CollectionNFTCrowdfund(globals);
    ...
    function setUp() public{
       ccf = CollectionNFTCrowdfund(
            payable(
                address(
                    new Proxy{ value: defaultInitialContribution }(
                        collectionNFTCrowdfundImpl,
                        abi.encodeCall(
                            CollectionNFTCrowdfund.initialize,
                            CollectionNFTCrowdfund.CollectionNFTCrowdfundOptions({
    ...
    function testShouldBeEligibleToBuyNFTIfGoalAchieved() external{
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate1);
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate2);
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate3);
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate4);
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate5);

        // Testing
        (uint256 ethContributed1, , ,) =ccf.getContributorInfo(contributor1);
        assertEq(ethContributed1, defaultUpperLimitInvestment);
        assertEq(ccf.delegationsByContributor(contributor1), contributor1);

        (uint256 ethContributedInitial, , ,) =ccf.getContributorInfo(defaultInitialContributor);
        ...
        assertEq(ccf.delegationsByContributor(contributor2), delegate2);

        (uint256 ethContributed3, , ,) =ccf.getContributorInfo(contributor3);
        assertEq(ethContributed3, defaultUpperLimitInvestment);
        assertEq(ccf.delegationsByContributor(contributor3), delegate3);

        (uint256 ethContributed4, , ,) =ccf.getContributorInfo(contributor4);
        assertEq(ethContributed4, defaultUpperLimitInvestment);
        assertEq(ccf.delegationsByContributor(contributor4), delegate4);

        (uint256 ethContributed5, , ,) =ccf.getContributorInfo(contributor5);
        assertEq(ethContributed5, defaultUpperLimitInvestment);
        assertEq(ccf.delegationsByContributor(contributor5), delegate5);

        assertEq(ccf.totalContributions(), defaultFundraiseGoal + defaultInitialContribution);
        assertEq(ccf.totalContributors(), 6);
    ...
    function testBuyAlsoTransfersFeeToMyMetaFi() external{
        ...
        vm.deal(contributor1, defaultUpperLimitInvestment);
        vm.prank(contributor1);
       ccf.contribute{ value: defaultUpperLimitInvestment/2 }(delegate1);
        // Contributing with contributor2
        address payable contributor2 = _randomAddress();
        address delegate2 = contributor2;
        vm.deal(contributor2, defaultUpperLimitInvestment);
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate2);
        ...
        vm.prank(contributor1);
       ccf.contribute{ value: defaultUpperLimitInvestment/2 }(delegate1_);
        // Contributing with contributor3
        address payable contributor3 = _randomAddress();
        address delegate3 = contributor3;
        vm.deal(contributor3, defaultUpperLimitInvestment);
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate5);
        ...
        assertEq((address(ccf).balance), 102.5 ether);
        ...
        ccf.getContributorInfo(contributor5);
        ...
        vm.prank(contributor5);
        ccf.claimUnusedContribution(contributor5);
        assertEq(contributor5.balance, ethOwed);
        // Check the balance left in crowdfund contract
        assertEq((address(ccf).balance), 0);
    }
    ...
    function testCanOnlyBuyNFTOfValueLeftAfterFee() external{
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate4);
        ...
        vm.prank(contributor5);
       ccf.contribute{ value: 717.5 ether }(delegate5);
    ...
    function testBuyNFTInLessAndRefundOthers() public {
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate5);
        ...
        assertEq(ccf.settledPrice(), 2050 ether);
       ...
       ccf.getContributorInfo(contributor3);
        assertEq(ethContributed3, defaultUpperLimitInvestment);
        ...
        vm.prank(contributor3);
       ccf.claimUnusedContribution(contributor3);
       ...
       ccf.getContributorInfo(contributor4);
        assertEq(ethContributed4, defaultUpperLimitInvestment);
        ...
        vm.prank(contributor4);
       ccf.claimUnusedContribution(contributor4);
       ...
       ccf.claimUnusedContribution(contributor5);
        assertEq(contributor5.balance, ethOwed);
        assertTrue(ccf.getCrowdfundLifecycle() == ICollectiveCrowdfund.CrowdfundLifecycle.Successful);
    }
    ...
    function testBuyNFTAndCheckVotingPower() public {
        ...
        vm.deal(contributor1, defaultUpperLimitInvestment);
        vm.prank(contributor1);
       ccf.contribute{ value: defaultUpperLimitInvestment/2 }(contributor1);
        // Contribute with 2 and delegate initial
        address payable contributor2 = _randomAddress();
        vm.deal(contributor2, defaultUpperLimitInvestment);
        vm.prank(contributor2);
       ccf.contribute{ value: 82 ether }(defaultInitialContributor); // Contributing only 10% first
        // Contributing again with 1 and delegating to 2
        vm.prank(contributor1);
       ccf.contribute{ value: 328 ether }(contributor2);
        // Contributing again with 1 and delegating himself
        vm.prank(contributor1);
       ccf.contribute{ value: 82 ether }(contributor1);
        // Contributing with 3 and delegating contributor1 to check his total delegated voting power now
        address payable contributor3 = _randomAddress();
        vm.deal(contributor3, defaultUpperLimitInvestment);
        vm.prank(contributor3);
       ccf.contribute{ value: 492 ether }(contributor1);
        // Contributing with 3 and delegating initial
        vm.prank(contributor3);
       ccf.contribute{ value: 123 ether }(defaultInitialContributor);
        // Contributing with 4 and delegating himself
        address payable contributor4 = _randomAddress();
        vm.deal(contributor4, defaultUpperLimitInvestment);
        vm.prank(contributor4);
       ccf.contribute{ value: 164 ether }(contributor4);
        // Again contributing 
        vm.prank(contributor4);
       ccf.contribute{ value: 656 ether }(contributor4);
       ...
       ccf.updateOnlyDelegate(defaultInitialContributor);
        ...
        vm.prank(contributor3);
       ccf.contribute{ value: 205 ether}(defaultInitialContributor);
       ...
       ccf.getContributorInfo(defaultInitialContributor);
        ...
        assertEq(ccf.totalContributions(), 2644.5 ether);

        // Contribute with 5 and delegate himself
        address payable contributor5 = _randomAddress();
        vm.deal(contributor5, defaultUpperLimitInvestment);
        vm.prank(contributor5);
       ccf.contribute{ value: defaultUpperLimitInvestment }(contributor5);
       ...
       ccf.contribute{ value: 82 ether }(defaultInitialContributor);

        
        assertEq(ccf.totalContributions(), 5330 ether);
        ...
        assertEq(erc721Vault.checkOwner(tokenId), address(collective_));
        // Check the values after buying
        assertEq(ccf.settledPrice(), 4715 ether);
       ...
       ccf.getContributorInfo(contributor1);
        assertEq(ethContributed1, defaultUpperLimitInvestment);
       ...
       ccf.getContributorInfo(contributor2);
        assertEq(ethContributed2, defaultUpperLimitInvestment);
        assertEq(ethUsed2, 287 ether);
        assertEq(ethOwed2, 533 ether);
        assertEq(votingPower2, 287 ether);
        assertEq(ccf.delegationsByContributor(contributor2), contributor2);
       ...
       ccf.getContributorInfo(contributor3);
        ...
        assertEq(ccf.delegationsByContributor(contributor3), defaultInitialContributor);
       ...
       ccf.getContributorInfo(contributor4);
        ...
        assertEq(ccf.delegationsByContributor(contributor4), defaultInitialContributor);
       ...
       ccf.getContributorInfo(contributor5);
        ...
        assertEq(ccf.delegationsByContributor(contributor5), contributor5);

        (uint256 ethContributed6, uint256 ethUsed6, uint256 ethOwed6, uint256 votingPower6) = 
       ccf.getContributorInfo(contributor6);
    ...
    function testCanClaimMoneyBackIfBoughtForFree() public {
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate5);
        ...
        assertEq(ccf.totalContributions(), 4202.5 ether);
        ...
        assertTrue(ccf.getCrowdfundLifecycle() == ICollectiveCrowdfund.CrowdfundLifecycle.Expired);
        // Check that NFT is now transferred to crowdfund
        assertEq(erc721Vault.checkOwner(tokenId), address(ccf));
        // Check the values after buying
        assertEq(ccf.settledPrice(), 0);
        assertTrue(ccf.isGiftedNFT());
    ...
    function test_CannotBuyIfFundraiseGoalIsnotAchieved() public {
        ...
        vm.deal(contributor1, defaultUpperLimitInvestment);
        vm.prank(contributor1);
       ccf.contribute{ value: contributor1.balance }(delegate1);
    ...
    function test_CannotBuyNFTOfFundraiseGoalValueIfTotalContriIsNotMore() external{
       ...
       ccf.contribute{ value: 717.5 ether}(delegate5);
        ...
        assertEq(ccf.totalContributions(), 4100 ether);
        ...
        4202.5 ether,ccf.totalContributions()));
        vm.prank(defaultInitialContributor);
       ccf.buy(
            tokenId,
            payable(openseaSeaport),
    ...
    function test_CannotBuyNFTOfTotalContributionsValue() external{
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate5);
        ...
        // Buying at same value to pass this test
        vm.expectRevert(abi.encodeWithSelector(ICollectiveCrowdfund.ExceedsTotalContributions.selector, 
        4307.5625 ether,ccf.totalContributions()));
        vm.prank(defaultInitialContributor);
       ccf.buy(
            tokenId,
            payable(openseaSeaport),
    ...
    function test_CannotBuyAboveTotalContributionsAmount() external{
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate5);
        ...
        vm.expectRevert(abi.encodeWithSelector(ICollectiveCrowdfund.ExceedsTotalContributions.selector, 
        4407.5 ether,ccf.totalContributions()));
        vm.prank(defaultInitialContributor);
       ccf.buy(
            tokenId,
            payable(openseaSeaport),
    ...
    function test_OnlyCollectiveHostCanBuy() public {
        // Contribute and delegate with contributor1
        address payable contributor1 = _randomAddress();
        address delegate1 = contributor1;
        vm.deal(contributor1, defaultUpperLimitInvestment);
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate1);
        ...
        // only contribute the left amount required.
        vm.prank(contributor1);
        vm.expectRevert(abi.encodeWithSelector(CollectionNFTCrowdfund.OnlyCollectiveHost.selector));
       ccf.buy(
            tokenId,
            payable(openseaSeaport),
            defaultCallValueToBuyNFT,
        ...
        assertTrue(ccf.getCrowdfundLifecycle() == ICollectiveCrowdfund.CrowdfundLifecycle.Active);
    }
    ...
    function test_BuyCannotReenter() public {
       ...
       ccf.contribute{ value: defaultUpperLimitInvestment }(delegate5);
        ...
        // Creating calldata of calling buy function which is already stuck somewhere
        bytes memory callData = abi.encodeCall(ccf.contribute, (contributor5));
        ...
        vm.prank(defaultInitialContributor);
        ccf.buy(tokenId, payable(address(ccf)), defaultCallValueToBuyNFT, callData);

        ReenteringContract reenteringContract = new ReenteringContract();

        // Creating calldata of calling buy function which is already stuck somewhere
        bytes memory callData1 = abi.encodeCall(reenteringContract.reenter, (ccf));
...
contract ReenteringContract is Test {
    function reenter(CollectionNFTCrowdfund ccf) external payable {
       ccf.contribute{ value: msg.value }(address(this));
    }
}
